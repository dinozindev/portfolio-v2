                ...
                <div className="flex flex-col w-4/5 lg:w-2/4 gap-4">
                    ...
                    <div className="flex justify-between">
                        <div className="text-md md:text-xl">
                            ...
                            <br></br>
                            <p>Tenho experiência no front-end com <span className="text-orange-300">React, Next.js, TypeScript, Styled Components, Tailwind CSS e Bootstrap 5</span>, aplicando boas práticas de componentização, responsividade e performance. No back-end, desenvolvo APIs com <span className="text-orange-300">Java Spring Boot e .NET Minimal APIs</span>, seguindo princípios de arquitetura limpa e boas práticas REST.</p>
                            <br></br>
                            <p>Trabalho com bancos relacionais <span className="text-orange-300">(Oracle, PostgreSQL e MySQL)</span>, além de pipelines de CI/CD com Azure DevOps e deploys utilizando <span className="text-orange-300">Docker e Microsoft Azure.</span></p>
                            <br></br>
