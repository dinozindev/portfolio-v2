...
const ProjectMiniWidget = ({ title, description, skills, linkGithub, linkWebsite, linkYoutube }: MiniWidgetProps) => {
    return (
        <div className="bg-miniwidget md:1/3 lg:w-1/4 px-6 py-9 flex flex-col justify-between shadow-2xl hover:translate-z-2.5 hover:-translate-y-2.5 transition-all">
