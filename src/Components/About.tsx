        ...
        <>
            <section className="flex items-center justify-evenly h-screen">
                <div className="flex flex-col w-3/4 lg:w-2/4 gap-2">
                    ...
                    <p className="text-xl md:text-2xl">Desenvolvedor Full-Stack com especialidade em React. Construo interfaces modernas, performáticas e escaláveis, utilizando as melhores práticas de desenvolvimento e design de interface.</p>
